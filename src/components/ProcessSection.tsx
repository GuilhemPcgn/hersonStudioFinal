const ProcessSection = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-studio-blue to-studio-blue/80">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="font-playfair text-4xl md:text-5xl font-bold text-studio-orange mb-4">
            Notre Processus
          </h2>
        </div>
