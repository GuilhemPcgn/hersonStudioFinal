...
const SocialMedia = () => {
  const socialLinks = [
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/herson_studio/',
      icon: (
    ...
    {
      name: 'TikTok',
      href: 'https://www.tiktok.com/@hersonstudio',
      icon: (
        <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
          <path d="M19.589 6.686a4.793 4.793 0 0 1-3.77-4.245V2h-3.445v13.672a2.896 2.896 0 0 1-5.201 1.743l-.002-.001.002.001a2.895 2.895 0 0 1 3.183-4.51v-3.5a6.329 6.329 0 0 0-1.023.096 6.39 6.39 0 0 0-5.16 6.245 6.39 6.39 0 0 0 6.39 6.39 6.39 6.39 0 0 0 6.39-6.39V8.687a8.182 8.182 0 0 0 4.773 1.526V7.38a4.831 4.831 0 0 1-1.379-.694z"/>
        </svg>
      ),
      bgColor: 'bg-black',
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/company/herson-prod/',
      icon: (
        <svg viewBox="0 0 16 16" className="w-5 h-5" fill="currentColor">
    ...
    {
      name: 'Mail',
      href: 'mailto:hersonscore@gmail.com',
      icon: (
        <svg viewBox="0 0 16 16" className="w-5 h-5" fill="currentColor">
    ...
    <div className="flex flex-col items-center space-y-4">
      ...
      <div className="text-center">
        <p className="text-xs text-muted-foreground">
          Instagram • TikTok • LinkedIn • Mail • WhatsApp
        </p>
      </div>
    </div>
  );
